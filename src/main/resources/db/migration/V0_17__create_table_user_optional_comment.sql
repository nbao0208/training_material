...
$$
    BEGIN
        ...
        (
            ...
            CONSTRAINT FK_tm_user_id_tm_user_optional_comment FOREIGN KEY (tm_user_id) REFERENCES public."tm_comment_rating" (tm_user_id)
        );
        ...
        COMMENT ON COLUMN "tm_user_optional_comment".tm_user_id IS 'The user ID from the comment_rating table because this users must have been rated';
